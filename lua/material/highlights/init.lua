...
M.main_highlights.treesitter = function()
	if vim.fn.has("nvim-0.8.0") == 1 then
		local treesitter_hls = {
			...
			["@lsp.mod.readonly.go"] = { fg = m.yellow },
			...
			["@variable.member"] = { fg = m.white }, -- Fields
			...
			["@punctuation.delimiter"] = { fg = m.gray },
			["@punctuation.bracket"] = { fg = m.gray },
			["@punctuation.special"] = { fg = m.gray },
